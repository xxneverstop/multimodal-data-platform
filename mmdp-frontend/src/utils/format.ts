...
const STATUS_TONES: Record<string, string> = {
  ...
  IMPORTED: "status-badge-info",
  MISSING_REQUIRED_ASSETS: "status-badge-warning",
  PASSED: "status-badge-success",
  PENDING: "status-badge-neutral",
  PLAYABLE: "status-badge-info",
  QC_FAILED: "status-badge-danger",
  QC_PASSED: "status-badge-success",
  QC_WARNING: "status-badge-warning",
  READY: "status-badge-success",
  REGISTERED: "status-badge-info",
  RUNNING: "status-badge-warning",
  SUCCESS: "status-badge-success",
  UPLOADED: "status-badge-info",
