...
#
# Code Developed by: Nima Ghorbani <https://nghorbani.github.io/>
...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        if '.npz' in bm_fname:
            ...
            raise ValueError('bm_fname should be a .npz file')
        ...
        self.model_type = {
            69: 'smpl', 153: 'smplh', 162: 'smplx',
            45: 'mano', 105: 'animal_horse', 102: 'animal_dog',
        }[njoints]
    ...
    def forward(self, root_orient=None, pose_body=None, pose_hand=None, pose_jaw=None,
                pose_eye=None, betas=None, trans=None, dmpls=None, expression=None,
                v_template=None, joints=None, v_shaped=None, return_dict=False, **kwargs):
